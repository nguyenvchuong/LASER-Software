...
#include "laikago_msgs/PybulletData.h"
#include "laikago_msgs/PybulletDataArray.h"
...
class CurrentState {
    public:
        ...
        void PybulletCallback(const laikago_msgs::PybulletDataArray& msg);
        
       // void HighStateCallback(const laikago_msgs::HighState& msg);
    private:
        ros::NodeHandle nm;
        ros::Subscriber servo_sub[12], footForce_sub[4], imu_sub, state_sub, qp_sub, pybullet_sub;
};
#endif
