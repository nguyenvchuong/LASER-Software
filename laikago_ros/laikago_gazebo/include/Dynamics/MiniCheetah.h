...
/*!
 * Generate a Quadruped my_model of Mini Cheetah
 */
template <typename T>
Quadruped<T> buildMiniCheetah() {
  ...
  kneeRotationalInertiaRotated = kneeRotationalInertiaRotated * 1e-6;  kneeRotationalInertia = RY * kneeRotationalInertiaRotated * RY.transpose();
