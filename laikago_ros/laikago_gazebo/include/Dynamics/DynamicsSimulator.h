...
class DynamicsSimulator {
 public:
  ...
  DynamicsSimulator(
      ...
      bool useSpringDamper = false);  //! Initialize simulator with given my_model
  ...
  /*!
   * Get the floating base my_model which is being simulated
   * @return floating base my_model
   */
