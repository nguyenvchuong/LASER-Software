 ...
 *  @brief Implementation of Rigid Body Floating Base my_model data structure
 *
...
/*!
 * The state of a floating base my_model (base and joints)
 */
template <typename T>
struct FBModelState {
...
/*!
 * Class to represent a floating base rigid body my_model with rotors and ground
...
class FloatingBaseModel {
 public:
  /*!
   * Initialize a floating base my_model with default gravity
   */
