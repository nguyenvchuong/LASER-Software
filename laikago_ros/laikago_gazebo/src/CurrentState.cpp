...
CurrentState::CurrentState() {
    //pybullet_sub = nm.subscribe("/infodata", 1, &CurrentState::PybulletCallback, this);
...
// void CurrentState::PybulletCallback(const laikago_msgs::PybulletDataArray& msg) {
//     lowState.cheat.position[0] = msg.base_pos[0];
//     lowState.cheat.position[1] = msg.base_pos[1];
//     lowState.cheat.position[2] = msg.base_pos[2];

//     lowState.cheat.vBody[0] = msg.world_velo[0];
//     lowState.cheat.vBody[1] = msg.world_velo[1];
//     lowState.cheat.vBody[2] = msg.world_velo[2];
//     std::cout << "got some data" << std::endl;
//     std::cout << msg.base_pos[2] << std::endl;
// }
