...
V_hip_front = state[:,][1:1200,36]*0.346 + state[:,][1:1200,24]
V_thigh_front = state[:,][1:1200,37]*0.346 + state[:,][1:1200,25]
V_calf_front = state[:,][1:1200,38]*0.346 + state[:,][1:1200,26]
V_hip_rear = state[:,][1:1200,42]*0.346 + state[:,][1:1200,30]
V_thigh_rear = state[:,][1:1200,43]*0.346 + state[:,][1:1200,31]
V_calf_rear = state[:,][1:1200,44]*0.346 + state[:,][1:1200,32]
