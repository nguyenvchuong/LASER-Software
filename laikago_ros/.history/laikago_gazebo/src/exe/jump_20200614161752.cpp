...
int main(int argc, char **argv)
{
    ...
    std::ifstream myFile;
    myFile.open("src/USC-AlienGo-Software/laikago_ros/optimization_data/data_Q.csv");
    ...
    // Read the joint velocity and position from optimization data
    std::ifstream mytauFile("src/USC-AlienGo-Software/laikago_ros/optimization_data/data_tau.csv");
